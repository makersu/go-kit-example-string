...
import (
	...
	http "github.com/makersu/go-kit-example-string/string/pkg/http"
...
var fs = flag.NewFlagSet("string", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "string")
